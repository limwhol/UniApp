...
<script>
  import { validator } from '../../js_sdk/validator/platformImage.js';

  const db = uniCloud.database();
  const dbCollectionName = 'platformImage';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("iconUrl,platformUrl,platformName,product_id").get().then((res) => {

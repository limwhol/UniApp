<template>
	<view class="addressForm">
		<u--form labelPosition="top" :model="addressForm" :rules="addressRules" ref="uForm" labelWidth="120">
			<u-form-item label="姓名" prop="username">
				<u--input v-model="addressForm.username" placeholder="请输入姓名"></u--input>
			</u-form-item>
			<u-form-item label="联系电话" prop="mobile">
				<u--input v-model="addressForm.mobile" placeholder="请输入电话号码"></u--input>
			</u-form-item>
